...
import com.github.leleact.jtest.dubbo.compatibility.api.EchoService;
...
public class TestDubboCompatibilityConsumerApplication {
    ...
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(TestDubboCompatibilityConsumerApplication.class,
                                                                      args);
