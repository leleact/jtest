...
public class MixPayOrderResponse {
    ...
    private TradeResult trade_result;
    ...
    public TradeResult getTrade_result() {
        return trade_result;
    }

    public void setTrade_result(TradeResult trade_result) {
    ...
    public String getTrade_discout_amount() {
        return trade_discout_amount;
    }

    public void setTrade_discout_amount(String trade_discout_amount) {
        this.trade_discout_amount = trade_discout_amount;
    }
